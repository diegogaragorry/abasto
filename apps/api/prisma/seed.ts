...
const products: SeedProduct[] = [
  ...
  { name: 'limon', category: ProductCategory.FRUTAS, baseUnit: ProductUnit.KG, sizeValue: 1, aliases: ['limon kg'] },
  ...
  { name: 'cebolla blanca', category: ProductCategory.VERDURAS, baseUnit: ProductUnit.KG, sizeValue: 1, aliases: ['cebolla', 'cebolla kg'] },
  ...
  { name: 'morron rojo', category: ProductCategory.VERDURAS, baseUnit: ProductUnit.KG, sizeValue: 1, aliases: ['morron rojo kg'] },
  { name: 'tomate', category: ProductCategory.VERDURAS, baseUnit: ProductUnit.KG, sizeValue: 1 },
  { name: 'lechuga mantecosa', category: ProductCategory.VERDURAS, baseUnit: ProductUnit.UNIT, sizeValue: 1, aliases: ['lechuga', 'lechugas', 'lechuga mantecosa c/u'] },
